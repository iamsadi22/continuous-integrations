...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		addtextdomain: {
			options: {
				textdomain: 'continuous-integrations'
			},
			update_all_domains: {
				options: {
					updateDomains: true
		...
		makepot: {
			target: {
				options: {
					...
					mainFile: 'continuous-integrations.php',
					domainPath: '/languages/',
					potFilename: 'continuous-integrations.pot',
					type: 'wp-plugin',
		...
		compress: {
			main: {
				options: {
					mode: 'zip',
					archive: './build/continuous-integrations-v' + pkg.version + '.zip'
				},
				expand: true,
				cwd: 'build/',
				src: ['**/*'],
				dest: 'continuous-integrations'
			}
		},
