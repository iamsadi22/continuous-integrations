 ...
 */
if ( false === strpos( getenv( 'WP_PHPUNIT__TESTS_CONFIG' ), '/continuous-integrations/' ) ) {
...
tests_add_filter(
	'muplugins_loaded',
	function() {
		require dirname( __DIR__, 2 ) . '/continuous-integrations.php';
	}
);

// Start up the WP testing environment.
require $wp . '/includes/bootstrap.php';
